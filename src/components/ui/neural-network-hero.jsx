...
const fragmentShader = `
  ...
  vec4 cppn_fn(vec2 coordinate, float in0, float in1, float in2) {
    ...
    * buf[7]
    ...
    // Convert to ORANGE color scheme
    float intensity = (buf[0].x + buf[0].y + buf[0].z) / 3.0;
    float r = 0.05 + intensity * 0.95;
    float g = 0.02 + intensity * 0.45;
    float b = 0.0 + intensity * 0.1;
...
function ShaderBanner({ height = "280px" }) {
...
export default function NeuralNetworkHero({
  ...
  description = "Empowering the next generation of innovators and leaders. Your journey in entrepreneurship starts here.",
  badgeText = "SSN College of Engineering",
  badgeLabel = "Entrepreneurship Club",
  ctaButtons = [
    { text: "Get Membership", href: "https://wa.me/918825992601?text=I%20want%20to%20be%20part%20of%20Lakshya%20community", primary: true },
  ...
  return (
    <section className="hero-section">
      {/* Shader Banner at Top */}
      <ShaderBanner height="280px" />
